...
public class LabelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LabelAdapter(List<Item> list, int resourceId, android.os.Handler handler) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        TextView label = holder.itemView.findViewById(R.id.label_label);
        label.setText(test.getLabel());
